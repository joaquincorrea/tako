...
def main(execution):
    ...
    start(name="example_workflow_function_reuse", log_dest='example_workflow_function_reuse.log',
          execution=execution)
    ...
    input_array12_parallel = InputArray("parallel data12", [task1_values, task1_values])
    output_parallel = parallel("my parallel", task_array12, input_array12_parallel)

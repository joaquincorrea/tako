...
import sys
from tigres import *
from tigres import InputTypes
from tigres.utils import Execution


input1_task1 = ['hello', 'hello1', 'hello2']
...
def main(execution):
    start(name="example_workflow_function_composedmerge", log_dest='example_workflow_function_composedmerge.log',
          execution=execution)
    ...
    task2 = Task("Task2", FUNCTION, task2impl, task2_types, None)
    # NOTE: Need to figure this out
    task2_values = InputValues("Input Task2", [input1_task1[1]])
    ...
    task1_values = InputValues("Input Task1", [output_parallel])
